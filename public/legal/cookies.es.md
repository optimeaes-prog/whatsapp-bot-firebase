...
Además de cookies, Proplead puede utilizar tecnologías similares como SDKs y scripts de terceros (por ejemplo, píxeles de seguimiento, Google Tag Manager), almacenamiento local del navegador (localStorage/sessionStorage) e identificadores de sesión en la aplicación web.
...
- **RGPD (UE) 2016/679**, aplicable a Talmate en virtud del art. 3.2
...
**Token de sesión Firebase** (Google LLC / Firebase) — Autenticación e inicio de sesión — Duración: sesión.

**Firebase Auth refresh token** (Google LLC / Firebase) — Renovación automática del token de sesión — Duración: persistente.

**__session** (Talmate / Firebase) — Mantenimiento de estado de sesión — Duración: sesión.

**Cookies de seguridad / anti-CSRF** (Talmate) — Prevención de ataques CSRF y fraude — Duración: sesión.
...
**Google Ads / Google Tag:** Mide qué anuncios de Google generan registros o compras. Para más información: https://policies.google.com/privacy

---

## 5. Base legal por categoría

**Cookies necesarias** — Art. 6.1.b (contrato) / Art. 6.1.f (interés legítimo — seguridad) — No requiere consentimiento.

**Cookies de analítica** — Art. 6.1.a (consentimiento) — Sí requiere consentimiento.

**Cookies de publicidad** — Art. 6.1.a (consentimiento) — Sí requiere consentimiento.
