...
import { X, AlertTriangle, User, Building2, UserCog } from "lucide-react";
...
const sectionTitleClass = "flex items-center gap-2 text-sm font-bold text-gray-900 font-heading mb-3 pb-2 border-b border-gray-100";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          {/* Sección 1: datos de contacto del propietario */}
          <section>
          ...
          {/* Sección 2: datos del inmueble captado */}
          <section>
            <h3 className={sectionTitleClass}>
              <Building2 size={15} className="text-primary-600" /> Datos del inmueble
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
          ...
          {/* Sección 3: asignación (solo gestores) */}
          {isManager && (
            <section>
              <h3 className={sectionTitleClass}>
                <UserCog size={15} className="text-primary-600" /> Asignación
              </h3>
              <div>
